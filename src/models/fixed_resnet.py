...
class FixedPreActResNet_cifar(nn.Module):
    def __init__(self,
                 block,
                 num_blocks,
                 filters,
        ...
        self.fc1 = nn.Linear(last_planes, fixed_classifier_feat_dim)
...
def FixedResNet20_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBlock, [3, 3, 3], [16, 32, 64], num_classes=out_dim, **kwargs)
...
def FixedResNet110_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBlock, [18, 18, 18], [16, 32, 64], num_classes=out_dim, **kwargs)


def FixedResNet29_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBottleneck, [3, 3, 3], [16, 32, 64], num_classes=out_dim, **kwargs)


def FixedResNet164_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBottleneck, [18, 18, 18], [16, 32, 64], num_classes=out_dim, **kwargs)


def FixedWideResNet_28_2_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBlock, [4, 4, 4], [32, 64, 128], num_classes=out_dim, **kwargs)


def FixedWideResNet_28_2_drop_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBlock, [4, 4, 4], [32, 64, 128], num_classes=out_dim, droprate=0.3, **kwargs)


def FixedWideResNet_28_10_cifar(out_dim=10, **kwargs):
    return FixedPreActResNet_cifar(PreActBlock, [4, 4, 4], [160, 320, 640], num_classes=out_dim, **kwargs)
